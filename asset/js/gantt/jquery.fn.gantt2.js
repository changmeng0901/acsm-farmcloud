                    ...
                    bar
                      .mouseover(function (e) {
                          ...
                          if((y_+height_+15)>windowHeight)
                        	  y_ = y_-5-height_;
                          if(typeof(settings.tipPosition) == "undefined"){
                        	  hint.css("left", e.pageX);
                          }else if(settings.tipPosition == "left"){
                        	  var width_ = _$(hint).width()+20;
                        	  hint.css("left", e.pageX - width_);
                          }
                      ...
                      .mousemove(function (e) {
                          ...
                          var width_ = _$(".fn-gantt-hint").width()+20;
                          if((y_+height_+15)>windowHeight)
                        	  y_ = y_-25-height_;
                          else
                        	  y_ +=15;
                          if(typeof(settings.tipPosition) == "undefined"){
                        	  ...
                        	  _$(".fn-gantt-hint").css("left", e.pageX - width_);
                          }
                        ...
                        _$.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "weeks":
                                    ...
                                    var cTo = to.attr("offset");
                                    var temp = document.getElementById("yearlic");
                                	temp = parseInt(temp,10);
                                    if(to.length == 0){
                                    	var weekid = dtTo.getWeekId();
                                    	var week_year = weekid.split("-")[1];
                                    	week_year = parseInt(week_year,10);
                                    	if(temp > week_year);
                                    	cTo = _$(element).find(".row.header.year").width();;
                                    }
