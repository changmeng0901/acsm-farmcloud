...
makeParameterField3 = function(videoId,ID){
    return encodeURI('&field={"'+videoId+'":"'+ID+'"}');
}
...
}else if(iframeSearch[0].split('=')[0] == '?tunnelId'){
	// videoId 说明是从种植列表页的监控点进来的
	ParameterField = makeParameterField('tunnelId',getVideoId);
}else{
