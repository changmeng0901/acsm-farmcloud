    ...
    $.fn.bigic = function () {
        ...
        Bigic.prototype.show = function(){
            ...
            oImg.onload = function(){
                ...
                oThis.leftw=oThis.nImgWid/2;
                 oThis.toptw=oThis.nImgHei/2;
                $('#LoadingBigic').attr('class','img-bigic');
                $('#LoadingBigic').attr('src',oThis.sImgSrc);
                $('.baseAddModel_body').css({
                    'width':oThis.nImgWid+'px',
                    'height':oThis.nImgHei+'px',
                    'margin-left':'-'+oThis.leftw+'px',
                    'margin-top':'-'+oThis.toptw+'px',
                });
                $('.baseAddModel_close').css({
                    'margin-left':oThis.nImgWid-oThis.leftw+'px',
                    'margin-top':'-'+(oThis.toptw+7)+'px',
        ...
        Bigic.prototype.popup = function(){
            ...
            $('.baseAddModel_close').off().on('click',function(){
                oThis.$popup.remove();
            });
            // 事件绑定 - 切换尺寸
        ...
        Bigic.prototype.zoom = function(){
            ...
            if(this.sImgStatus == 'min'){
                ...
                this.$img.css({'position':'fixed','width': nWid +'px', 'height': nHei +'px', 'left': '50%', 'top': '50%', 'margin-top': -nHei/2+'px', 'margin-left': -nWid/2+'px'});
