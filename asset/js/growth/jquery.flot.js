    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
				...
				isXShow : true,//横向坐标联显
                colors: ["#e0f0ff", "#afd8f8", "#cb4b4b", "#4da74d", "#9440ed"],
                legend: {
                    show: true,
                ...
                xaxis: {
                    ...
                    color: '#ffffff', // base color, labels, ticks
                    tickColor: '#37414b', // possibly different color of ticks, e.g. "rgba(0,0,0,0.15)竖轴线颜色"
