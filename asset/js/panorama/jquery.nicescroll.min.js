...
o||(v.wheelprevented=!1)}),v.bind(jQuery(window),"resize",v.lazyResize),v.bind(jQuery(window),"orientationchange",v.lazyResize),v.bind(jQuery(window),"load",v.lazyResize),x.ischrome&&!v.ispage&&!v.haswrapper){var M=v.win.attr("style"),E=parseFloat(v.win.css("width"))+1
