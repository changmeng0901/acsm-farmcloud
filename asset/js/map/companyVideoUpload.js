...
var uploader1 = new plupload.Uploader({
    ...
    filters: {
        ...
        { title : "Image files", extensions : "mp4,avi,rmvb,wmv,3gp,amv,dmv,rm" }, 
        ],
	...
	init: {
		...
		FilesAdded: function(up, files) {
			plupload.each(files, function(file) {
				document.getElementById('ossfile').innerHTML += '<div   id="' + file.id + '"><b1></b1>'
		...
		Error: function(up, err) {
            if (err.code == -600) {
            	...
            	parent.document.getElementById("productMsg").innerHTML = "该视频已经上传过了！";
            	parent.jquery("#myModal").modal('show');
            }
            else 
            {
