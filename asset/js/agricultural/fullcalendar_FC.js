...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		if (isDayNumberVisible) {
			var tempHtml = "";
			if(typeof(view.options.total[date.toISOString()]) != "undefined")
				tempHtml = view.options.total[date.toISOString()];
		...
		//html += '<p>test3</p></td>';
		//新增共项-项待完成
		html += '<p class="newcal-txt">'+tempHtml+'</p></td>';
