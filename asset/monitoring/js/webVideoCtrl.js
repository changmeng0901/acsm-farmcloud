		...
		var t = function() {
					...
					j = function(e) {
						e.oStreamCapa.bObtained || e.oProtocolInc instanceof tt && (G == e.szDeviceType || X == e.szDeviceType || H == e.szDeviceType ? e.oProtocolInc.getStreamChannels(e, {
							...
							success: function(t) {
								...
								for (var s = jQuery(t).find("streamingTransport", !0).length, n = 0; s > n; n++) if ("shttp" == jQuery(t).find("streamingTransport").eq(n).text().toLowerCase()) {
				...
				nt.prototype._alert = function(e) {
					...
					s.prototype.find = function(e, t) {
						...
						if (I.browser().msie) {
	                		return this.elems[this.length - 1] ? t ? void(I.browser().msie ? this.elems[this.length - 1].text = t : this.elems[this.length - 1].textContent = t) : I.browser().msie ? this.elems[this.length - 1].text : this.elems[this.length - 1].textContent: ""
	                	} else {
				...
				rt.prototype.extend = function() {
					...
					if (I.browser().msie) {
						...
						s.async = !1;
						s.loadXML(t);
					} else if (!I.browser().msie && e.DOMParser) {
						var n = new DOMParser;
